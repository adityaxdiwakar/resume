	...
	\resumeSubHeadingListStart
		\resumeSubheading
			...
			{\scriptsize { \footnotesize{\newline{}\textbf{Courses:}
                \textit{Automata Theory}, \textit{Systems \& Networks},
                Computer Architecture, Machine Learning, Stochastic Processes,
...
\section{Experience}
	\resumeSubHeadingListStart
		...
		\resumeItemListStart
            ...
            theory, and computability/complexity to 200+ students}
            ...
            \resumeItem{Ensured course and student success by organizing 
                assignments/exams; delegated work for other TAs}
		\resumeItemListEnd
		\resumeSubheading
            {Loganov Data}
            {Remote}
