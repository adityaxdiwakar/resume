...
\section{Projects}
    ...
    \begin{itemize}
        \vspace{-1.5mm}
        \item{\textbf{OCamLC-3:} Develoed assembler for LC-3 assembly with
                cusom lexing, parsing, and assembling using OCaml and Regex.
                Implemented CLI with partial outputs for lexed, parsed, and
                assembled states.\
        }
        \vspace{-1mm}
